...
return [
    'base64image'          =>'The :attribute must be a valid base64 encoded image.',
    ...
    'password' => [
        ...
        'mixed' => 'يجب أن يحتوي :attribute على حرف واحد على الأقل من الأحرف الكبيرة والصغيرة.',
        'numbers' => 'يجب أن يحتوي :attribute على رقم واحد على الأقل.',
        'symbols' => 'يجب أن يحتوي :attribute على رمز واحد على الأقل.',
        'uncompromised' => 'ظهر :attribute المُقدم في تسريب بيانات. يرجى اختيار :attribute مختلف.',
    ...
    */
    ...
    'attributes' => [
        ...
        "cityId"            =>"المدينة",
        "languageId"            =>"اللغة",
        "currentlySell"         =>"طريقة البيع",
        "manyProductHave"     =>"عدد المنتجات",
        "templateCategoryId"     =>"التصنيف الرئيسي",
        "storeDomain"           =>"دومين المتجر",
    ],
];
